...
if resposta == 'Y':
    ...
    driver_options.set_preference('profile',  "C:\Users\user_Augusto\AppData\Roaming\Mozilla\Firefox\Profiles\pe10l2dw.default-release")
   
    
    driver = webdriver.Firefox(service=Service(
        GeckoDriverManager().install()), options=driver_options)
